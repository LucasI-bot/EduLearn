window.addEventListener("turbolinks:load", function() {
    document.body.addEventListener("click", function(event) {
        ...
        if (event.target === addOptionButton) {
            ...
            textbox.setAttribute('oninvalid', "this.setCustomValidity(' ')");
            textbox.setAttribute('oninput', "this.setCustomValidity('')");
            ...
            btnDelete.setAttribute('onclick', 'deleteOption(this)');
