function validateForm(){
    ...
    if(fields.length > 0){
        if(fields[0].parentElement.textContent.replace(/\s/g, '').toLowerCase().includes("contraseña") && !fields[0].parentElement.textContent.replace(/\s/g, '').toLowerCase().includes("confirmar") ){
